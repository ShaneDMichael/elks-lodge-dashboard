...
function initRoomPicker() {
  ...
  const rooms = [
    ...
    { title: 'Banquet Hall - far side', model: 'Elks_Lodge_Banquet_Hall.glb', deviceId: 'EE59003C66482' },
    ...
    { title: 'Bar Room', model: 'Elks_Lodge_Bar_Room.glb', deviceId: 'EE77644866123' },
